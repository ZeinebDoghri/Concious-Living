...
class AuthRoleSelectorScreen extends StatelessWidget {
  const AuthRoleSelectorScreen({super.key});
  ...
  Future<void> _chooseRole(BuildContext context, String role) async {
    ...
    try {
      ...
      if (e.code == 'permission-denied') {
        showErrorSnackBar(context, 'Access denied. Please sign in again.');
      } else {
        showErrorSnackBar(context, 'Error: ${e.message ?? e.code}');
      }
    } catch (e) {
      if (!context.mounted) return;
