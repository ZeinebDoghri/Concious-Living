...
class _ExpiryDatePageState extends State<ExpiryDatePage> {
  ...
  Future<void> _saveToFirestore() async {
    ...
    try {
      ...
      // ✅ Encode image as base64 string for Firestore storage
      ...
      await docRef.set({
        'id': docRef.id,
        'name': productName,
        'imageBase64': imageBase64,      // ✅ product image stored
        'expiryDate': expiryDt != null
            ? Timestamp.fromDate(expiryDt)
            : null,
        'expiryDateRaw': _expiryDate,    // ✅ raw date string stored
        'status': inventoryStatus,       // 'fresh' | 'expiring' | 'spoiled'
        'quantity': 1.0,
        'unit': 'pcs',
